...
<script type="text/javascript">
	function query() {
		...
		//alert(document.getElementById("catalog_name"));
...
/* 		alert(document.getElementById("key").value);
		alert(document.getElementById("catalog_name").value);
	...
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<form id="actionForm" action="${pageContext.request.contextPath }/filterQuery.action" method="POST">
				<div class="form">
