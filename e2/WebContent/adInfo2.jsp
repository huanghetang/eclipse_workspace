...
<!-- 	<div class="container" id="idTransformView">
	...
	<div class="block clearfix Main">
		...
		<!-- 左侧文章 -->
		<div style="width:1000px;height:354px;border:1px solid #ccc;position:absolute;top:0;left:270px;border-radius:5px;">
			<h2 style="background:#F5F5F5;text-align:center;font-size:14px;height:32px;line-height:32px;padding:0 12px;">${adInfo.ad_title}</h2>
			<div style="padding:20px;over-flow:hidden;">
				${adInfo.ad_content}
				<br>
				<c:if test="${not empty adInfo.ad_image}">
					<img alt="广告图片" src="${adInfo.ad_image}" >
				</c:if>
		    </div>
		</div>	
		<!-- 左侧文章 -->
