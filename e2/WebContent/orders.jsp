						...
						<c:if test="${not empty orderList}">
							...
							<tr>
								...
								<c:if test="${o.status==2}">
									<td align="center" bgcolor="#ffffff">
										<a href="OrderController?method=orderDetail&oid=${o.id}"><font color="red">待审核</font></a>
									</td>
								</c:if>
								<c:if test="${o.status==3}">
									<td align="center" bgcolor="#ffffff">
										<a href="OrderController?method=orderDetail&oid=${o.id}"><font color="green">正在退货...</font></a>
									</td>
								</c:if>
								<c:if test="${o.status==4}">
											<td align="center" bgcolor="#ffffff"><a
												href="OrderController?method=orderDetail&oid=${o.id}"><font
													color="gray">订单过期</font></a></td>
								</c:if>
								<td align="center" bgcolor="#ffffff">
									<a href="OrderController?method=orderDetail&oid=${o.id}">查看详情</a>
									</td>
							</tr>
							</c:forEach>
						</table>
