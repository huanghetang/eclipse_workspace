				...
				<div class="block">
					<div class="f_l left_login">
						...
						<c:if test="${not empty loginUser }">
							<font id="ECS_MEMBERZONE"> 欢迎&nbsp;${loginUser.nickname }&nbsp;光临本店，
								<a style="color:blue;" href="loginOut.jsp">退出</a>
							</font>
						</c:if>
					...
					<div class="header_r">
						<a href="${pageContext.request.contextPath}/orderServlet?methodName=queryOrderList">我的订单</a>
						<a href="productServlet">商品列表</a>
					</div>
				</div>
			</div>
		</div>
			...
			<ul class="cart_info">
				<li id="ECS_CARTINFO">
					<div class="top_cart">
						...
						<a href="cartServlet?methodName=queryCart" class="shopborder">去购物车结算</a>
					</div>
				</li>
			</ul>
		</div>
