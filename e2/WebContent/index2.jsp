...
<body class="index_page" style="min-width:1200px;">
	...
	<div class="container" id="idTransformView">
		<ul class="slider" id="idSlider">
			<li class="li1">
				<a href="javascript:;"><%-- <img id="lunbo_1" alt="${node.title }"	src="${node.pic }"> --%>
				<img id="lunbo_1" alt="8.30-9.5 月饼"	src="/images/aa472cb9f9624d22d1fcfd1c4dffbe42.jpg">
				</a>
			</li>
			
			<li class="li2">
				<a href="javascript:;">
				<img id="lunbo_2" alt="8.23-8.29大闸蟹" src="/images/516e4d058d1d65a3506e179642297b2d.jpg">
				</a>
			</li>
			<li class="li3">
				<a href="javascript:;">
				<img id="lunbo_3" alt="8.30-9.5 中秋综合" src="/images/e886f76e03f7a3596033eb34ca362339.jpg">
				</a>
			</li>
			<li class="li4">
				<a href="javascript:;">
				<img id="lunbo_4" alt="8.30-9.5 水果" src="/images/757e35fab995b43c23b4396dc3ba4269.jpg">
				</a>
			</li>
			<li class="li5">
				<a href="javascript:;">
				<img
					...
					src="/images/1748dcf682d7f595012e4309695d71d9.jpg">
				</a>
			</li>
		</ul>
