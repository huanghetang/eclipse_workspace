...
<body>
	...
	<c:forEach items="${pageBean.data}" var="product">
		<div class="col-md-2" style="height: 230px">
			<a href="product_info.htm"> <img src="${root}/${product.pimage}"
	...
	<div style="width: 480px; margin: 0 auto; margin-top: 50px;">
		...
		<!-- 	<li class="active"><a href="#">1</a></li> -->
			<c:forEach items="${pageBean.bar}" var="pageNumber">
				<li <c:if test="${pageNumber == pageBean.pageNum}">class="active"</c:if>>
					<a href="${root}/product/page?pageNum=${pageNumber}">${pageNumber}</a>
				</li>
			</c:forEach>
